            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap mb-3 gap-2" id="image-list-1">
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/1.png') }}"
                            alt="avatar" height="50" width="50" />
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/2.png') }}"
                            alt="avatar" height="50" width="50" />
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/3.png') }}"
                            alt="avatar" height="50" width="50" />
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/4.png') }}"
                            alt="avatar" height="50" width="50" />
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/5.png') }}"
                            alt="avatar" height="50" width="50" />
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/6.png') }}"
                            alt="avatar" height="50" width="50" />
                    </div>
                    <div class="d-flex flex-wrap gap-2" id="image-list-2">
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/7.png') }}"
                            alt="avatar" height="50" width="50" />
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/8.png') }}"
                            alt="avatar" height="50" width="50" />
                        <img class="rounded-circle drag-item cursor-move" src="{{ asset('assets/img/avatars/9.png') }}"
                            alt="avatar" height="50" width="50" />
