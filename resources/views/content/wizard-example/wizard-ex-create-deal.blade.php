                ...
                <div id="deal-type" class="content">
                    <div class="row g-3">
                        <div class="col-12 d-flex justify-content-center border rounded pt-4">
                            <img src="{{ asset('assets/img/illustrations/wizard-create-deal-girl-with-laptop-' . $configData['style'] . '.png') }}"
                                        ...
                                        <label class="form-check-label custom-option-content" for="customRadioFlat">
                                            <span class="custom-option-body">
                                                <svg width="41" height="40" viewBox="0 0 41 40" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M4 15.1406H36.5V30C36.5 30.3315 36.3683 30.6495 36.1339 30.8839C35.8995 31.1183 35.5815 31.25 35.25 31.25H5.25C4.91848 31.25 4.60054 31.1183 4.36612 30.8839C4.1317 30.6495 4 30.3315 4 30V15.1406Z"
                                                        fill="currentColor" fill-opacity="0.2" />
                                                    <path
                                                ...
                                                <small>Create a deal which offer uses flat $ off (i.e $5 OFF) on the
                                                    total.</small>
                                            </span>
                                            <input name="customRadioIcon" class="form-check-input" type="radio"
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" name="dealAmount" id="dealAmount" class="form-control"
                                placeholder="25" min="0" max="100" aria-describedby="dealAmountHelp" />
                ...
                <div id="review-complete" class="content">
                    <div class="row g-3">
                                ...
                                <div class="col-12 mb-0">
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="ps-0 align-top text-nowrap py-1"><strong>Deal Title</strong>
                                                </td>
                        ...
                        <div class="col-xl-6 col-lg-5 d-flex justify-content-center border rounded pt-3">
                            <img class="img-fluid"
                                src="{{ asset('assets/img/illustrations/wizard-create-deal-confirm.png') }}"
                                alt="deal image cap" />
                        </div>
                        <div class="col-md-12">
                            <label class="switch">
