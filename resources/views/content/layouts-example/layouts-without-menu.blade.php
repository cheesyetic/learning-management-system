    ...
    <div class="layout-demo-wrapper">
        <div class="layout-demo-placeholder">
            @if ($configData['layout'] === 'horizontal')
                <img src="{{ asset('assets/img/layouts/layout-horizontal-without-menu-' . $configData['style'] . '.png') }}"
            ...
            @else
                <img src="{{ asset('assets/img/layouts/layout-without-menu-' . $configData['style'] . '.png') }}"
                    class="img-fluid" alt="Layout without menu" data-app-light-img="layouts/layout-without-menu-light.png"
