                ...
                <div class="col-12 col-lg-6 mb-4 mb-xl-0">
                    ...
                    <div class="demo-inline-spacing mt-3">
                        <div class="list-group">
                            ...
                            <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                                <img src="{{ asset('assets/img/avatars/8.png') }}" alt="User Image"
                                    class="rounded-circle me-3 w-px-50">
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <div class="user-info">
                            ...
                            <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                                <img src="{{ asset('assets/img/avatars/4.png') }}" alt="User Image"
                                    class="rounded-circle me-3 w-px-50">
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <div class="user-info">
                            ...
                            <div class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                                <img src="{{ asset('assets/img/avatars/11.png') }}" alt="User Image"
                                    class="rounded-circle me-3 w-px-50">
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <div class="user-info">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="demo-inline-spacing mt-3">
                        <div class="list-group">
                            ...
                            <a href="javascript:void(0);"
                                class="list-group-item list-group-item-action d-flex align-items-center p-3">
                                <div class="badge bg-danger rounded p-1 me-3"><i class="ti ti-brand-angular ti-xl"></i>
                                </div>
                                <div class="w-100">
                            ...
                            <a href="javascript:void(0);"
                                class="list-group-item list-group-item-action d-flex align-items-center p-3">
                                <div class="badge bg-info rounded p-1 me-3"><i class="ti ti-brand-react-native ti-xl"></i>
                                </div>
                                <div class="w-100">
                            ...
                            <a href="javascript:void(0);"
                                class="list-group-item list-group-item-action d-flex align-items-center p-3">
                                <div class="badge bg-warning rounded p-1 me-3"><i
                                        class="ti ti-brand-javascript ti-xl"></i></div>
                                <div class="w-100">
