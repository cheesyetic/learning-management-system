    ...
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-primary" role="alert">
                        This is a primary alert with an <a href="" class="alert-link"> example link</a> Give it a
                        click.
                    </div>

                    <div class="alert alert-secondary" role="alert">
                        This is a secondary alert with an <a href="" class="alert-link"> example link </a> Give it a
                        click.
                    </div>

                    <div class="alert alert-success" role="alert">
                        This is a success alert with an <a href="" class="alert-link"> example link </a> Give it a
                        click.
                    </div>

                    <div class="alert alert-danger" role="alert">
                        This is a danger alert with an <a href="" class="alert-link"> example link </a> Give it a
                        click.
                    </div>

                    <div class="alert alert-warning" role="alert">
                        This is a warning alert with an <a href="" class="alert-link"> example link </a> Give it a
                        click.
                    </div>

                    <div class="alert alert-info" role="alert">
                        This is a info alert with an <a href="" class="alert-link"> example link </a> Give it a
                        click.
                    </div>

                    <div class="alert alert-dark mb-0" role="alert">
                        This is a dark alert with an <a href="" class="alert-link"> example link </a> Give it a
                        click.
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-primary alert-dismissible" role="alert">
                        ...
                        <p class="mb-0">Sugar plum apple pie sesame snaps croissant marshmallow apple pie liquorice.
                            Cheesecake bear claw tiramisu shortbread cupcake. Sugar plum candy canes jujubes liquorice
                            tiramisu gummi bears muffin dragée gingerbread.</p>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        </button>
                    </div>
                    <div class="alert alert-secondary alert-dismissible" role="alert">
