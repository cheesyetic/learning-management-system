                ...
                <div>
                    ...
                    <div class="dropdown dropup footer-link me-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="javascript:void(0);"><i class='ti ti-currency-dollar'></i>
                                USD</a>
                            <a class="dropdown-item" href="javascript:void(0);"><i class='ti ti-currency-euro'></i> Euro</a>
                            <a class="dropdown-item" href="javascript:void(0);"><i class='ti ti-currency-pound'></i>
                                Pound</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="javascript:void(0);"><i class='ti ti-currency-bitcoin'></i>
                                Bitcoin</a>
                        </div>
                    </div>
            ...
            <div class="container-fluid container-p-x pt-5 pb-4">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-3 mb-4 mb-sm-0">
                        <h4 class="fw-bolder mb-3"><a href="{{ config('variables.livePreview') }}" target="_blank"
                                class="footer-text">{{ config('variables.templateName') }} </a></h4>
