                    ...
                    <div class="col-xl-4 p-4">
                        ...
                        <div class="demo-inline-spacing">
                            <p>
                                ...
                                <span class="badge badge-center rounded-pill bg-secondary"><i
                                        class="ti ti-sun"></i></span>
                                <span class="badge badge-center rounded-pill bg-success"><i
                                        class="ti ti-check"></i></span>
                                <span class="badge badge-center rounded-pill bg-danger"><i class="ti ti-clock"></i></span>
                                <span class="badge badge-center rounded-pill bg-warning"><i
                                        class="ti ti-cloud"></i></span>
                                <span class="badge badge-center rounded-pill bg-info"><i class="ti ti-folder"></i></span>
                                <span class="badge badge-center rounded-pill bg-dark"><i
