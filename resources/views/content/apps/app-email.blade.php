                    ...
                    <div class="emails-list-header p-3 py-lg-3 py-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center mb-0 mb-md-2">
                                ...
                                <div class="dropdown">
                                    <i class="ti ti-dots-vertical cursor-pointer" id="emailsActions"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown me-2">
                                    <i class="ti ti-folder cursor-pointer" id="dropdownMenuFolder"
                                ...
                                <div class="dropdown">
                                    <i class="ti ti-tag cursor-pointer" id="dropdownLabel" data-bs-toggle="dropdown"
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="dropdown ms-3">
                                <i class="ti ti-dots-vertical cursor-pointer" id="dropdownMoreOptions"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                </i>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown me-3">
                                <i class="ti ti-folder cursor-pointer" id="dropdownMenuFolder" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                </i>
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuFolder">
                                    <a class="dropdown-item" href="javascript:void(0)">
                    ...
                    <div class="card email-card-prev mx-sm-4 mx-3">
                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown me-3">
                                    <i class="ti ti-dots-vertical cursor-pointer" id="dropdownEmail"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    </i>
                    ...
                    <div class="modal-body flex-grow-1 pb-sm-0 p-4 py-2">
                        <form class="email-compose-form">
                            ...
                            <div class="email-compose-actions d-flex justify-content-between align-items-center mt-3 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="dropdown">
                                        <i class="ti ti-dots-vertical cursor-pointer" data-bs-toggle="dropdown"
