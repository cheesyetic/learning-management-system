                            ...
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <a class="btn btn-sm btn-label-primary"
                                        href="{{ url('pages/help-center-article') }}">Read More</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="badge bg-label-success p-2 rounded me-2"><i
                                                class="ti ti-shopping-cart ti-sm"></i></span>
                                        <h5 class="fw-semibold mt-3 ms-1">eCommerce</h5>
                                    </div>
                                    <ul>
                                        <li class="text-primary py-1"><a
                                                href="{{ url('pages/help-center-categories') }}">Pricing Wizard</a></li>
                                        <li class="text-primary pb-1"><a
                                                href="{{ url('pages/help-center-categories') }}">Square Sync</a></li>
                                    </ul>
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="badge bg-label-info p-2 rounded me-2"><i
                                                class="ti ti-device-laptop ti-sm"></i></span>
                                        <h5 class="fw-semibold mt-3 ms-1">Building Your Website</h5>
                                    </div>
                                    <ul>
                                        <li class="text-primary py-1"><a
                                                href="{{ url('pages/help-center-categories') }}">First Steps</a></li>
                                        <li class="text-primary pb-1"><a
                                                href="{{ url('pages/help-center-categories') }}">Add Images</a></li>
                                    </ul>
                                    <p class="mb-0 fw-semibold">
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul>
                                        <li class="text-primary py-1"><a
                                                href="{{ url('pages/help-center-categories') }}">Insights</a></li>
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="badge bg-label-danger p-2 rounded me-2"><i
                                                class="ti ti-world ti-sm"></i></span>
                                        <h5 class="fw-semibold mt-3 ms-1">Domains and Email</h5>
                                    </div>
                                    <ul>
                                        <li class="text-primary py-1">
                                            <a href="{{ url('pages/help-center-categories') }}">Access to Admin
                                                Account</a>
                                        </li>
                                        <li class="text-primary pb-1">
                                            <a href="{{ url('pages/help-center-categories') }}">Send Email From an
                                                Alias</a>
                                        </li>
                                    </ul>
                                    <p class="mb-0 fw-semibold">
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="badge bg-label-warning p-2 rounded me-2"><i
                                                class="ti ti-device-mobile ti-sm"></i></span>
                                        <h5 class="fw-semibold mt-3 ms-1">Mobile Apps</h5>
                                    </div>
                                    <ul>
                                        <li class="text-primary py-1">
                                            <a href="{{ url('pages/help-center-categories') }}">Getting Started with the
                                                App</a>
                                        </li>
                                        <li class="text-primary pb-1">
                                            <a href="{{ url('pages/help-center-categories') }}">Getting Started with
                                                Android</a>
                                        </li>
                                    </ul>
                                    <p class="mb-0 fw-semibold">
                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="badge bg-label-secondary p-2 rounded me-2"><i
                                                class="ti ti-mail ti-sm"></i></span>
                                        <h5 class="fw-semibold mt-3 ms-1">Email Marketing</h5>
                                    </div>
                                    <ul>
                                        <li class="text-primary py-1"><a
                                                href="{{ url('pages/help-center-categories') }}">Getting Started</a></li>
                                        <li class="text-primary pb-1">
                        ...
                        <div class="col-md-4 mb-md-0 mb-4">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3"> Expert tips and tools to improve your website or online store using
                                        our blog. </p>
                                    <a class="btn btn-sm btn-label-primary"
                                        href="{{ url('pages/help-center-categories') }}">Read More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-md-0 mb-4">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3"> Inspiration from experts to help you start and grow your big ideas.
                                    </p>
                                    <a class="btn btn-sm btn-label-primary"
                                        href="{{ url('pages/help-center-categories') }}">Read More</a>
                                </div>
                        ...
                        <div class="col-md-4 mb-md-0 mb-4">
                            <div class="card border shadow-none">
                                <div class="card-body text-center">
                                    ...
                                    <p class="mb-3"> A group of people living in the same place or having a particular.
                                    </p>
                                    <a class="btn btn-sm btn-label-primary"
                                        href="{{ url('pages/help-center-categories') }}">Read More</a>
                                </div>
        ...
        <div class="container-xl">
            <div class="row justify-content-center py-5">
                <div class="col-md-8 col-lg-6 text-center mt-4">
                    ...
                    <p class="mb-3"> Our specialists are always happy to help. Contact us during standard business hours
                        or email us 24/7 and we'll get back to you. </p>
