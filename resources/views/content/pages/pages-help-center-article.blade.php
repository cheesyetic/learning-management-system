            ...
            <div class="card overflow-hidden">
                <div class="card-body">
                    ...
                    <p>
                        ...
                        be made
                        and presented with the actual content still not being ready. Think of a news blog that's filled with
                        content
                        hourly on the day of going live. However, reviewers tend to be distracted by comprehensible content,
                        say, a
                    ...
                    <p>
                        ...
                        the
                        Boundaries of Goods and Evils; finibus may also be translated as purposes). Neque porro quisquam est
                        qui
                        dolorem ipsum quia
                        dolor sit amet, consectetur, adipisci velit is the first known version ("Neither is there anyone who
                        loves
                        grief itself since it
                        is grief and thus wants to obtain it"). It was found by Richard McClintock, a philologist, director
                        of
                        publications at Hampden-Sydney College in Virginia; he
                        searched for citings of consectetur in classical Latin literature, a term of remarkably low
                        frequency in that
                        literary corpus.
                    </p>
                    <p>
                    ...
                    <div class="article-votes">
                        <a href="javascript:void(0);" class="badge bg-label-primary me-2 p-2"><i
                                class="ti ti-thumb-up ti-xs"></i></a>
                        <a href="javascript:void(0);" class="badge bg-label-primary p-2"><i
                                class="ti ti-thumb-down ti-xs"></i></a>
                    </div>
                </div>
            </div>
        </div>
