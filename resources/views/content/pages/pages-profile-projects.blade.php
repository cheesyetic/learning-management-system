                ...
                <div class="card-header">
                    <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="me-2 ms-1">
                                <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-body">Social
                                        Banners</a></h5>
                                <div class="client-info"><strong>Client: </strong><span class="text-muted">Christian
                                        Jimenez</span></div>
                            </div>
                        </div>
                        <div class="ms-auto">
                            <div class="dropdown zindex-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item text-danger" href="javascript:void(0);">Leave Project</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="me-2 ms-1">
                                <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-body">Admin
                                        Template</a></h5>
                                <div class="client-info"><strong>Client: </strong><span class="text-muted">Jeffrey
                                        Phillips</span></div>
                            </div>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0">Time is our most valuable asset, that's why we want to help you save it by creating…
                    </p>
                </div>
                <div class="card-body border-top">
                    <div class="d-flex align-items-center mb-3">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="me-2 ms-1">
                                <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-body">App Design</a>
                                </h5>
                                <div class="client-info"><strong>Client: </strong><span class="text-muted">Ricky
                                        McDonald</span></div>
                            </div>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="me-2 ms-1">
                                <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-body">Create
                                        Website</a></h5>
                                <div class="client-info"><strong>Client: </strong><span class="text-muted">Hulda
                                        Wright</span></div>
                            </div>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="me-2 ms-1">
                                <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-body">Figma
                                        Dashboard</a></h5>
                                <div class="client-info"><strong>Client: </strong><span class="text-muted">Jerry
                                        Greene</span></div>
                            </div>
                        </div>
                        <div class="ms-auto">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-start">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="me-2 ms-1">
                                <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-body">Logo
                                        Design</a></h5>
                                <div class="client-info"><strong>Client: </strong><span class="text-muted">Olive
                                        Strickland</span></div>
                            </div>
                        </div>
                        <div class="ms-auto">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0">Premium logo designs created by top logo designers. Create the branding of business.
                    </p>
                </div>
                <div class="card-body border-top">
                    <div class="d-flex align-items-center mb-3">
