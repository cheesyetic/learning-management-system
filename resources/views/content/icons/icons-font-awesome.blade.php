...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Icons /</span> Font Awesome
    </h4>

    <p>You can check complete list of font awesome icon from <a href="https://fontawesome.com/"
            target="_blank">https://fontawesome.com</a></p>
