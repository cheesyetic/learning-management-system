...
@section('title', 'Modifikasi Materi')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col text-center">
            <h2>Modifikasi Materi</h2>
        </div>
        <form action="{{ route('teacher.material.update', $material->id) }}" class="form mx-auto" method="POST"
            ...
            <div class="form-group col-lg-6 mx-auto mt-2">
                ...
                <textarea class="form form-control" required rows="5" id="description" name="description">{{ old('description', $material->description) }}</textarea>
            </div>
            <div class="form-group col-lg-6 mx-auto mt-2">
                <label for="file">Upload Dokumen Pendukung (Jangan diisi apabila tidak ingin diubah - Maksimal 5
                    Mb)</label>
