...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('auth.student')->group(function () {
        Route::group(['prefix' => 'student', 'as' => 'student.'], function () {
            ...
            Route::put('penugasan/{task}', [TaskController::class, 'update'])->name('task.update');
            Route::delete('penugasan/{task}', [TaskController::class, 'destroy'])->name('task.destroy');
            Route::get('penugasan/{file}/download', [TaskController::class, 'download'])->name('task.download');
            ...
            Route::put('profile/security', [ProfileController::class, 'change_password'])->name('profile.change_password');
        });
    });
    ...
    Route::middleware('auth.teacher')->group(function () {
        Route::group(['prefix' => 'teacher', 'as' => 'teacher.'], function () {
            ...
            Route::get('penugasan/{task}', [TeacherTaskController::class, 'show'])->name('task.show');
            Route::get('penugasan/{task}/edit', [TeacherTaskController::class, 'edit'])->name('task.edit');
            Route::post('penugasan', [TeacherTaskController::class, 'store'])->name('task.store');
            Route::put('penugasan/{task}', [TeacherTaskController::class, 'update'])->name('task.update');
            Route::delete('penugasan/{task}', [TeacherTaskController::class, 'destroy'])->name('task.destroy');
            Route::get('penugasan/{file}/download', [TeacherTaskController::class, 'download'])->name('task.download');
            Route::get('penugasan/{task}/publish-status', [TeacherTaskController::class, 'publishStatus'])->name('task.publish-status');

            //Assignment
            Route::get('hasil-penugasan', [AssignmentController::class, 'task_index'])->name('assignment.task.index');
            ...
            //Material
            Route::get('materi', [TeacherMaterialController::class, 'index'])->name('material.index');
            Route::get('materi/create', [TeacherMaterialController::class, 'create'])->name('material.create');
            Route::get('materi/{material}', [TeacherMaterialController::class, 'show'])->name('material.show');
            Route::get('materi/{material}/edit', [TeacherMaterialController::class, 'edit'])->name('material.edit');
            Route::post('materi', [TeacherMaterialController::class, 'store'])->name('material.store');
            Route::put('materi/{material}', [TeacherMaterialController::class, 'update'])->name('material.update');
            Route::delete('materi/{material}', [TeacherMaterialController::class, 'destroy'])->name('material.destroy');
            Route::get('materi/{file}/download', [TeacherMaterialController::class, 'download'])->name('material.download');
            Route::get('materi/{material}/publish-status', [TeacherMaterialController::class, 'publishStatus'])->name('material.publish-status');

            //Chat
            Route::get('chat', [TeacherChatController::class, 'index'])->name('chat.index');
            ...
            Route::get('profile/security', [TeacherProfileController::class, 'security'])->name('profile.security');
            Route::put('profile/security', [TeacherProfileController::class, 'change_password'])->name('profile.change_password');
        });
    });
